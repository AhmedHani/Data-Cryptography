...
{
    public class RepeatingKeyVigenere : Strategy
    {
        ...
        public override string encrypt(string text, string key)
        {
            ...
            while (keyActualLength < textActualLength)
            {
            ...
            for (int i = 0; i < textActualLength; i++)
            {
                ...
                decryptedPureText += this.tabulaRecta[textCharIndex, keyCharIndex];
            ...
            for (int i = 0; i < nonAlphaLength; i++)
            {
                ...
                decryptedText[currentNonAlphaIndex] = nonAlpha[i][0];
